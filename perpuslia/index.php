    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">perpus <sup>2</sup></div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="index.php?page=peminjaman" data-toggle="collapse" data-target="#collapseTwo"
